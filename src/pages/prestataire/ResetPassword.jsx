...
const ResetPassword = () => {
    ...
    const handleSend = async()=>{
        ...
        const res =await authAPIPrestataire.resetPassword({password, password_confirmation, token, email,type:'prestataires'})
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="form-contact col-md-6 col-12">
                                            <div className="form-group">
                                                <label htmlFor="telephone">Entrer un nouveau mot de passe </label>
                                                <input type="text" className="form-control" id="password" value={password} onChange={(e)=>setPassword(e.target.value)} placeholder="Entrez votre mot de passe" />
                                            </div>
                                            <div className="form-group">
                                                <label htmlFor="telephone">confirmer votre mot de passe</label>
                                                <input type="text" className="form-control" id="password_confirmation" value={password_confirmation} onChange={(e)=>setPassword_confirmation(e.target.value)} placeholder="Entrez à nouveau votre mot de passe" />
                                            </div>

...
const [concours,setConcours] = useState(data.concours==null?"":data.concours)
...
setLoading(true)
                    ...
                    <Form onSubmit={handleSubmit} className="px-2 pb-2">
                        ...
                        <div className="flex flex-column h-12rem pr-3 mb-3 gap-5">
                            ...
                            {type == "BAC" && (
                             ...
                             {(type == "CONCOURS") && (<div className="flex flex-column h-12rem pr-3 mb-3 gap-5">
                                                            <Form.Control
                                                                type="text"
                                                                name="concours"
                                                                className="mb-3 h-12rem"
  ...
  <option value="Médecine 3">Médecine 3</option>
                        ...
                        {(filiere != "" || concours!=""||(type == "BAC" && serie != "")) && type != "" && (
                            <Button
                                type="submit"
                                label="Modifier"

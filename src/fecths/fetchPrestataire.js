...
export const authAPIPrestataire = {
  ...
  register: async (credentials) => {
    try {
      console.log(credentials);
      const response = await API.post("prestataire/register", credentials); // Inscription via API
  ...
  nouvelAbonnement: async (credentials) => {
    ...
    try {
      console.log(credentials);
      const response = await API.post("prestataire/abonnement", credentials, {
        headers: {
  ...
  allPrestataires: async () => {
    try {
      ...
      console.log("Sujets fusionnés et triés :", Prestataire.data.data.data);

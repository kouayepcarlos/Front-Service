    ...
    <div className="general">
      ...
      <div className="my-custom-div">
        ...
        <section className="mb-5">
          <Redirection
            texte={`Bienvenue chez ${vendeur?.nom}! Votre satisfaction est notre priorité. Découvrez nos produits et passez vos commandes en toute confiance.`}
          />{" "}
                ...
                <li>
                  ...
                  <Modal show={show2} onHide={handleClose2} className="Modal">
                    <Modal.Header closeButton>
                      <Modal.Title>Informations vendeur</Modal.Title>
                    </Modal.Header>
                    <Modal.Body className="info-vendeur">
                      ...
                      <div>
                        {" "}
                        <span>Email: &nbsp;</span> <p>{vendeur?.email}</p>
                      </div>
                      {vendeur?.description && (
                        <div>
                          {" "}

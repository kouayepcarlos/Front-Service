...
const Connexion = () => {
  const { loginMutationvendeur } = useRegister();
      ...
      <div className="my-custom-div">
        ...
        <section className="mb-5">
          ...
          <section className="row tab-contact mx-md-3">
              ...
              <div className="row">
                ...
                <div className="form-contact col-md-6 col-12">
                  ...
                  <button
                    ...
                    type="submit"
                    disabled={loginMutationvendeur.isLoading}
                  >
                    {loginMutationvendeur.isLoading
                      ? "Connexion..."
                      : "Se Connecter"}
                  </button>
                </div>
            ...
            <a href="/vendeur/passe_oublie">Mot de passe oublié</a>
          </section>
        </section>
        <Chat />
        <Footer />

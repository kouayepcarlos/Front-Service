...
const Homevendeur = () => {
    ...
    const villesDisponibles = useMemo(() => {
        return boutiques
            ? [...new Set(boutiques.map((b) => b.ville))]
            : [];
    }, [boutiques]);
                ...
                <section className="mb-5">
                    ...
                    <div className="mx-5 mb-4">
                        ...
                        <div className="d-flex flex-wrap gap-3 flex-md-nowrap">
                            <select name="ville" value={filters.ville} className="form-select" onChange={handleFilterChange}>
                            ...
                            <select name="quartier" value={filters.quartier} className="form-select" onChange={handleFilterChange}>

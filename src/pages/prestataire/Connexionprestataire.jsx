...
const Connexion = () => {
  const { loginMutationprestataire, messageConnexion } = useRegister();
    ...
    <div className="general">
      ...
      <div className="my-custom-div">
        ...
        <section className="mb-5">
          {!nom && (
            <Redirection
              texte="Vous avez déjà un compte ? Connectez-vous et prester vos services"
          ...
          <section className="row tab-contact mx-md-3">
              ...
              <div className="row">
                ...
                <div className="form-contact col-md-6 col-12">
                  ...
                  <button
                    ...
                    type="submit"
                    disabled={loginMutationprestataire.isLoading}
                  >
            ...
            <a href="/prestataire/passe_oublie">Mot de passe oublié</a>
          </section>
        </section>
        <Chat />
        <Footer />
